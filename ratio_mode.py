...
from filter_model import mobileObjects_ratio
    ...
    with torch.no_grad():
        ...
        for sequence in sequence_files:
            ...
            if(len(image_files)>=2):
                ...
                mobject = mobileObjects_ratio(ratio_age=args.ratio, lost_age=args.lost_age+args.sort_age, threshold=0.9,
                                                min_age=args.filter_age)
                ...
                output = sequence.replace("KITTI_raw", "KITTI_motion_ratio")
